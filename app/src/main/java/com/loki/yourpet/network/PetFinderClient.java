...
import static com.loki.yourpet.Constants.PET_ACCESS_TOKEN;
import static com.loki.yourpet.Constants.PET_BASE_URL;
                    ...
                    .addInterceptor(new Interceptor() {
                        ...
                        public Response intercept(Chain chain) throws IOException {
                            Request newRequest = chain.request().newBuilder()
                                    .addHeader("Authorization", PET_ACCESS_TOKEN)
                                    .build();
